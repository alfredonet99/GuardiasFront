    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100 dark:bg-slate-950 transition px-4">
        <div className="w-full max-w-md bg-white/70 dark:bg-slate-900/50  border border-slate-300 dark:border-slate-700 rounded-xl shadow-xl backdrop-blur-sm overflow-hidden">
            <div className="p-8 text-center">
                ...
                <h2 className="text-xl font-bold text-slate-800 dark:text-white"> El enlace ha expirado</h2>
                ...
                <div className="mt-6 space-y-3">
                    <NavLink to="/restaurar-password" className="block w-full py-2 rounded-md bg-blue-600 hover:bg-blue-700 text-white font-medium shadow transition">
                        Solicitar un nuevo enlace
                    </NavLink>

                    <NavLink to="/login" className="block w-full py-2 rounded-md bg-slate-300 hover:bg-slate-400 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-200 font-medium transition">
