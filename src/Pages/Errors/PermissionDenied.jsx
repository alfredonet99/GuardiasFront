...
export default function PermissionDenied() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-100 dark:bg-slate-950 text-slate-700 dark:text-slate-300 px-6 py-10">
      ...
      <button onClick={() => navigate("/inicio", { replace: true })} className="mt-4 flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-800 text-white dark:bg-slate-700 dark:hover:bg-slate-600 hover:bg-slate-700 transition">
        <FiArrowLeft />
        Volver
      </button>
    </div>
