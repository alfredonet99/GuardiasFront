...
export default function DeleteConfirm({ isOpen, message, onCancel, onConfirm,}) {
                ...
                <div className="rounded-2xl border border-slate-200/80 bg-white shadow-xl shadow-slate-900/10 dark:bg-slate-900 dark:border-slate-700">
                    <div className="flex items-start justify-between px-5 pt-4">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100"> Eliminar Elemento </h2>
                        </div>
                    ...
                    <div className="px-5 pt-2 pb-4">
                        <p className="text-base text-slate-600 dark:text-slate-300 leading-relaxed whitespace-pre-line"> {message} </p>
                    </div>
