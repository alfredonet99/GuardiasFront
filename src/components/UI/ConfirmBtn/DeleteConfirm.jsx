				...
				<div className="rounded-2xl border border-slate-200/80 bg-white shadow-xl shadow-slate-900/10 dark:bg-slate-900 dark:border-slate-700">
					<div className="flex items-start justify-between px-5 pt-4">
						...
						<button
							type="button"
							onClick={onCancel}
							className="inline-flex items-center justify-center rounded-full p-1.5 text-slate-400 hover:text-slate-600 hover:bg-slate-100
					...
					<div className="flex items-center justify-end gap-3 px-5 pb-4 pt-1">
						<button
							type="button"
							onClick={onCancel}
							className="px-4 py-2 text-sm rounded-lg border border-slate-300 text-slate-700 bg-whitehover:bg-slate-100dark:border-slate-600 dark:text-slate-200 dark:bg-slate-900dark:hover:bg-slate-800 transition"
						>
							Cancelar
						</button>
						...
						<button
							type="button"
							onClick={onConfirm}
							className="px-4 py-2 text-sm rounded-lg bg-rose-600 text-white hover:bg-rose-700 shadow-sm shadow-rose-600/40transition"
						>
							Eliminar
						</button>
					</div>
