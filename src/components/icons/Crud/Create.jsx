...
export default function IconCreate({ label, to }) {
	...
	return (
		<NavLink
			to={to}
			className="flex items-center gap-2 bg-blue-600 text-white text-sm px-4 py-2 rounded-lg shadow hover:bg-blue-700 active:bg-blue-800 transition select-none"
		>
			<FiPlus />
